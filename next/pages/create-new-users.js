...
export default function createNewUser() {
  ...
  const postNewUser = async () => {
    ...
    try {
      ...
      let rolesID = {
        "peer leader": "60a4689d5d345b000e77f8c1",
      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            checked={"genyus admin" === radio}
          />
          <label htmlFor="genyus admin">genyus Admin</label>
          <br />
          <input
            type="radio"
            id="research partner"
            ...
            onChange={(e) => setRadio(e.target.value)}
            checked={"research partner" === radio}
          />
          <label htmlFor="research partner">Research Partner</label>
          <br />
          <input
            type="radio"
            id="peer leader"
            ...
            value="peer leader"
            onChange={(e) => setRadio(e.target.value)}
            checked={"peer leader" === radio}
          />
          <label htmlFor="peer leader">Peer Leader</label>
          <br />
